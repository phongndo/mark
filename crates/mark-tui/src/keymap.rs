...
const GLOBAL_ACTION_SPECS: &[GlobalActionSpec] = &[
    ...
    global_action_spec!(GlobalAction::ReviewTarget, "review_target", ["m r"]),
    global_action_spec!(GlobalAction::HeadBranch, "head_branch", ["m h"]),
    global_action_spec!(GlobalAction::BaseBranch, "base_branch", ["m b"]),
    global_action_spec!(GlobalAction::CommitPicker, "commit_picker", ["m s"]),
    ...
    global_action_spec!(GlobalAction::VisualMode, "visual_mode", ["v", "V"], 1),
    ...
    global_action_spec!(GlobalAction::NextFile, "next_file", ["tab"]),
    ...
    global_action_spec!(GlobalAction::NextDiffType, "next_diff_type", []),
    global_action_spec!(GlobalAction::PreviousDiffType, "previous_diff_type", []),
