...
impl DiffTheme {
    ...
    pub(crate) fn tokyonight() -> Self {
        ...
        Self {
            ...
            statusline_bg: base.surface().color(),
    ...
    pub(crate) fn base16(scheme: Base16Scheme) -> Self {
        Self {
            ...
            gutter_bg: scheme.base00.surface().color(),
            ...
            statusline_bg: scheme.base00.surface().color(),
