...
text to the terminal clipboard when the button is released, then clears the
highlight. In split view, the selection stays in the pane where the drag started.
